...
export class CatalogoComponent implements OnInit {
  libros: Libro[] = [
    { id: 1, titulo: 'Cien años de soledad', autor: 'Gabriel García Márquez', editorial: 'Harper & Row', año: 1967, genero: 'Realismo mágico', descripcion: 'Una de las obras más importantes de la literatura latinoamericana.', imagen: 'https://example.com/cover1.jpg' },
    { id: 2, titulo: 'El Quijote', autor: 'Miguel de Cervantes', editorial: 'Francisco de Robles', año: 1605, genero: 'Novela clásica', descripcion: 'Clásico de la literatura española y universal.', imagen: 'https://example.com/cover2.jpg' },
    { id: 3, titulo: 'La ciudad y los perros', autor: 'Mario Vargas Llosa', editorial: 'Seix Barral', año: 1963, genero: 'Novela moderna', descripcion: 'Novela que critica la sociedad militarizada en Lima.', imagen: 'https://example.com/cover3.jpg' },
  ];
